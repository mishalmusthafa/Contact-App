...
function Register() {
  ...
  return (
    <div className='bg-base-200'>
      ...
      <div className="hero min-h-128 bg-base-200">
        ...
        max-w-sm shadow-2xl bg-base-100">
            <form className="card-body" onSubmit={onSubmit}>
              <div className="form-control">
                ...
                <input type="text" name='name' value={name} onChange={onChange} placeholder="name" className="input input-bordered h-10 lg:h-12" required />
              </div>
              <div className="form-control">
                <label className="label">
              ...
              <div className="form-control">
                ...
                <input type="password" name='password' value={password} onChange={onChange} placeholder="password" className="input input-bordered h-10 lg:h-12" required />
              </div>
              <div className="form-control relative">
                <label className="label" htmlFor='password'>
                  <span className="label-text">Confirm Password</span>
                </label>
                <input type={!passwordVisible ? 'password' : 'text'} name='password2' value={password2} onChange={onChange} placeholder="confirm password" className="input input-bordered h-10 lg:h-12" required />
